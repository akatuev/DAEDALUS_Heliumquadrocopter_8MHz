...
void writeMotors() { // [1000;2000] => [125;250]
  ...
  /********  Specific PWM Timers & Registers for the atmega328P (Promini)   ************/
    ...
    #endif
    #if (NUMBER_MOTOR > 2)
        OCR2A = motor[2]>>3; //  pin 11 // Bitshift von 3 auf 4 veraendert...
    #endif
    #if (NUMBER_MOTOR > 3)
        OCR2B = motor[3]>>3; //  pin 3  // Dadurch wird die high time halbiert
    #endif
    #if (NUMBER_MOTOR > 4)
      #if (NUMBER_MOTOR == 6) && !defined(SERVO)
        #ifndef EXT_MOTOR_RANGE 
...
void initOutput() {
  ...
  /********  Specific PWM Timers & Registers for the atmega328P (Promini)   ************/
      ...
      ICR1 |= 0x2000; // TOP wird auf 8192 gesetzt: vrmtl. wg. habler Taktfrequenz // no prescaler & TOP to 16383;
