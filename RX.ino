...
void configureReceiver() {
  /******************    Configure each rc pin for PCINT    ***************************/
    ...
    PCICR = PCIR_PORT_BIT;  // HIER: 0b00000100 == (1<<2) siehe def.h
                            // PCIE2 Flag wird gesetzt
                            // pin change interrupt 2 is enabled. Any change on any enabled PCINT[23:16] pin will cause an interrupt.
                            // Ard(2) = D2 = PD2(INT0)
                            // Ard(4) = D4 = PD4(XCK/T0/PCINT20)
                            // Ard(5) = D5 = PD5(T1/PCINT21)
                            // Ard(6) = D6 = PD6(AIN0/PCINT22)


    
    /*************    atmega328P's Specific Aux2 Pin Setup    *********************/
    // wird beim HQC nicht mit kompiliert
